...
- **Paso "curiosidad" (bidón que se llena):** familia "contenedor + líquido + tasa lineal por minuto" cercana a `fuentes-demre-liberadas/paes-m1-2026-forma113.md:366-368` (estanque de 720L vaciándose a 3L/min). Verbo opuesto (llenar vs. vaciar) y mecánica distinta (tabla de descubrimiento vs. fórmula dada).
