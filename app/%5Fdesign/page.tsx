    ...
    <main className="min-h-screen bg-screen px-4 py-10 sm:px-6">
      <div className="mx-auto flex max-w-5xl flex-col gap-10">
        ...
        <Seccion
          ...
          nota="El momento del cierre de lección y del de módulo, en sus dos estados. Con aciertos suficientes el sello se estampa, el visto se traza y el tramo crece hacia la estación siguiente (700ms); sin ellos el anillo se asienta igual —llegaste— pero queda hueco y el tramo no se mueve (220ms). El estado bueno termina más lejos de donde empezó; el malo termina donde empezó, y esa asimetría es lo que dice la pieza. La silueta va en --linea-nav y no en --linea: el amarillo de la 02 sobre el fondo da 1,66:1 y el sello quedaría invisible justo en el eje del módulo v1. El color del eje vive en el núcleo, ahora teñido (--linea-tinte) para que el visto tenga un campo con el que contrastar: el par tinte / sobre-tinte da 4,90 · 16,50 · 5,58 · 5,84. Lo que separa un estado del otro es el visto, no la presencia del disco. Va aria-hidden: es decoración, los datos están en las dos tarjetas y en el título."
        >
          <div className="flex flex-col gap-6">
            <PorLinea>
              {() => (
