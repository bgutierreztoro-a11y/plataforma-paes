...
/* `IconoSalir` —la flecha del modo foco— se borró en la fase 3H: la barra de la
   maqueta escribe "Salir" con todas sus letras y el ícono quedó sin consumidor.
   Ver components/leccion/HeaderLeccion.tsx. */
